...
INSERT INTO "public"."bw_policy" ("policy_id", "account_id", "name", "settings", "created_at", "updated_at", "deleted_at") 
...
INSERT INTO "public"."bw_pool" ("pool_id", "account_id", "name", "settings", "created_at", "updated_at", "deleted_at") 
...
INSERT INTO "public"."bw_machine" ("account_id", "created_at", "deleted_at", "device_ip", "device_name", "device_type", "group_id", "hardware_version", "mac", "policy_id", "pool_id", "setting", "software_version", "updated_at") 
