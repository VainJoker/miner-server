...
INSERT INTO "public"."bw_account" ("uid", "name", "email", "email_verified_at", "password", "failed_attempt", "status", "last_login", "local_currency", "system_lang", "created_at", "updated_at", "deleted_at") VALUES (6192889942050345986, 'VJ', 'vainjoker@163.com', NULL, '$argon2id$v=19$m=19456,t=2,p=1$qx5HhB7crer58ao9Lyov6g$9QK5ZzCQTOlie/8lefC72EwCLrlp3r89bIbLR3dK2qo', 0, 'inactive', NULL, 'USD', 'en-US', '2024-05-21 09:37:51.894308', NULL, NULL);
...
INSERT INTO "public"."bw_machine" ("uid", "created_at", "deleted_at", "device_ip", "device_name", "device_type", "group_id", "hardware_version", "mac", "policy_id", "pool_id", "setting", "software_version","exist", "updated_at")
VALUES ('6192889942050345985', '2024-06-16 09:49:07.221466', NULL, '192.168.110.97', '', 'Goldshell-MiniDOGEPro', NULL, 'GP.CI.IA', '28:e2:97:3e:6f:06', 6194821006046008322, NULL, '{"crypto_coin":[{"symbol":"LTC","algorithm":"scrypt"}],"power_modes":["Power"],"support_led":true,"pool_maximal":3,"support_boot":true,"support_reset":true,"support_update":true}', '2.2.8', false, NULL);
INSERT INTO "public"."bw_machine" ("uid", "created_at", "deleted_at", "device_ip", "device_name", "device_type", "group_id", "hardware_version", "mac", "policy_id", "pool_id", "setting", "software_version","exist", "updated_at")
VALUES ('6192889942050345986', '2024-06-16 09:49:07.221466', NULL, '192.168.110.97', '', 'Goldshell-MiniDOGEPro', NULL, 'GP.CI.IA', '28:e2:97:3e:6f:06', 6194821006046008322, NULL, '{"crypto_coin":[{"symbol":"LTC","algorithm":"scrypt"}],"power_modes":["Power"],"support_led":true,"pool_maximal":3,"support_boot":true,"support_reset":true,"support_update":true}', '2.2.8', true, NULL);
...
INSERT INTO "public"."bw_account_setting" ("uid", "key", "created_at", "updated_at", "deleted_at") VALUES (6192889942050345985, 'dd99c54c08bb2752f5f8ad6e526243cbea722', '2024-06-24 10:03:42', NULL, NULL);
